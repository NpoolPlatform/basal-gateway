...
[![Test](https://github.com/NpoolPlatform/basal-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/basal-gateway/actions/workflows/main.yml)
...
* make basal-gateway ```单独编译服务```
* make basal-gateway-image ```单独生成服务镜像```
